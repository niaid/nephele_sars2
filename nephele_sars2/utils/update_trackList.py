...
snps = {
    ...
    "urlTemplate": "tracks/samples/{}/{}/{}_filtered_snps.ann.vcf.gz".format(
        fcid, category, sample_id
    ),
}
...
indels = {
    ...
    "storeClass": "JBrowse/Store/SeqFeature/VCFTabix",
    "type": "JBrowse/View/Track/HTMLVariants",
    "urlTemplate": "tracks/samples/{}/{}/{}_filtered_indels.vcf.gz".format(
        fcid, category, sample_id
    ),
}
...
bam = {
    ...
    "urlTemplate": "tracks/samples/{}/{}/{}_downsampled.bam".format(
        fcid, category, sample_id
    ),
}
...
bw = {
    ...
    "urlTemplate": "tracks/samples/{}/{}/{}_coverage.bam.bw".format(
        fcid, category, sample_id
    ),
    "autoscale": "local",
    "scale": "log",
...
pilon_snps = {
    ...
    "storeClass": "JBrowse/Store/SeqFeature/VCFTabix",
    "type": "JBrowse/View/Track/HTMLVariants",
    "urlTemplate": "tracks/samples/{}/{}/{}_pilon.vcf.gz".format(
        fcid, category, sample_id
    ),
}
...
cons_snps = {
    ...
    "storeClass": "JBrowse/Store/SeqFeature/VCFTabix",
    "type": "JBrowse/View/Track/HTMLVariants",
    "urlTemplate": "tracks/samples/{}/{}/{}_consensus_snps.vcf.gz".format(
        fcid, category, sample_id
    ),
}
