...
RUN mamba install -y -c conda-forge -c bioconda samtools==1.18 bcftools==1.17 trimmomatic==0.39 bwa==0.7.18 picard==3.1.1 gatk4==4.5.0.0 pilon==1.24 bedtools==2.31.1 deeptools==3.5.5 pysam==0.21.0 seaborn==0.13.2 nextflow=22.10.6 r-base==4.2.2 ivar==1.4.2 jvarkit==2024.04.20 awscli
RUN pip install pypairix==0.3.7
